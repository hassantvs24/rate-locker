        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-xl-5 ms-auto">
                    <form action="{{route('booking_request')}}" type="get" class="review-box-home">
                        ...
                        <div class="review-input">
                            <div class="review-input-box w-100">
                                ...
                                <input type="number" name="number" min="1" max="100" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Adult">
                            </div>
                            <div class="review-input-box w-100">
                                <input type="number" name="number" min="0" max="100" placeholder="Child">
                            </div>
                            <div class="review-input-box w-100">
                                <input type="number" name="number" min="1" max="100" placeholder="Room">
                            </div>
                        </div>
                        <div class="review-input">
